...
<body>
    ...
    <div class="container">
        ...
        <main id="culturasr" class="pages_cultura" role="main">
          <div class="row text-start">
            <b><a href="../cultura/index.php">Home</a> <i class="bi bi-arrow-right"></i> <a href="../cultura/culturaarte.php">Cultura e Arte</a></b>
          </div>
            <article role="article" aria-labelledby="article-heading" aria-label="seção da página destacando os principais pontos culturais e artísticos presentes em São Roque, enumerando seis desses monumentos e pontos">
                <div class="col-12">
                    <h2 id="article-heading">PONTOS CULTURAIS</h2>
                    <div class="row col-12">
                      <section class="col-md-6 monumento_cultural" role="region" aria-labelledby="section-heading">
                        <h3 id="section-heading">Roteiro do Vinho</h3>
                          <figure class="text-center">
                              <img src="../imgs/cultura/roteirovinho1.webp" alt="uma foto frontal da Vinícola Goes, a principal vinícola de São Roque e uma das primeiras" role="img">
                          </figure>
                      ...
                      <section class= "col-md-6 monumento_cultural" role="region" aria-labelledby="section-heading">
                        <h3 id="section-heading">Brasital</h3>
                        <figure class="text-center">
                            <img src="../imgs/cultura/brasital.webp" alt="foto tirada da entrada da Brasital, com os prédios e a torre capturados e um céu aberto." role="img">
                        </figure>
                        ...
                        <figure class="text-center">
                          <picture>
                            <source srcset="../imgs/cultura/brasital2.webp" media="(min-width: 992px)" role="img"><img src=".." alt="">
                          </picture>
                        </figure>
                      </section>
                    </div>
                    <div class="row col-12">
                      <section class= "col-md-6 monumento_cultural" role="region" aria-labelledby="section-heading">
                        <h3 id="section-heading">Quilombo do Carmo</h3>
                        <figure class="text-center">
                            <img src="../imgs/cultura/quilombocarmo2.webp" alt="parte da comunidade do Quilombo do Carmo, com algumas casas e uma árvore" role="img">
                        </figure>
                      ...
                      <section class="col-md-6 monumento_cultural" role="region" aria-labelledby="section-heading">
                          <h3 id="section-heading">Capela Santo Antônio</h3>
                          <figure class="text-center">
                              <img src="../imgs/cultura/capelasantoantônio.webp" alt="Entrada da Capela de Santo Antônio, localizada no Sítio Santo Antônio, uma relíquia do passado da cidade na época bandeirante" role="img">
                          </figure>
                    ...
                    <div class="row col-12">
                    <section class="col-md-6 monumento_cultural" role="region" aria-labelledby="section-heading">
                          <h3 id="section-heading">Morro do Saboó</h3>
                          <figure class="text-center">
                              <img src="../imgs/cultura/morrosaboó.webp" alt="visão de longe do Morro do Saboó, um dos principais símbolos naturais da cidade e o ponto mais alto desta também" role="img">
                          </figure>
                      ...
                      <section class="col-md-6 monumento_cultural" role="region" aria-labelledby="section-heading">
                          <h3 id="section-heading">Morro do Cruzeiro</h3>
                          <figure class="text-center">
                              <img src="../imgs/cultura/morrocruzeiro.webp" alt="foto tirada abaixo do monumento no Morro, capturando a cruz e parte da estátua de São Roque enquanto ocorre uma procissão próxima" role="img">
                          </figure>
            ...
            <aside class="row col-12 secao_artistas" role="complementary" aria-label="área contendo algumas bandas e grupos artísticos presentes em São Roque. Na seção, há listado três deles">
                    <h2>GRUPOS ARTÍSTICOS</h2>
                    <div class="row grupos">
                      <section class="col-md-6 col-lg-4 grupo" role="region" aria-labelledby="section-heading">
                        <h3 id="section-heading">Coletivo Entre Nós</h3>
                        <figure class="text-center">
                            <img src="../imgs/cultura/coletivoentrenos.webp" alt="apresentação de uma das produções de Páscoa do Coletivo Entre Nós, famoso coletivo de teatro de São Roque" role="img">
                        </figure>
                      ...
                      <section class="col-md-6 col-lg-4 grupo" role="region" aria-labelledby="section-heading">
                        <h3 id="section-heading">Companhia de Eros</h3>
                        <figure class="text-center">
                            <img src="../imgs/cultura/companhiaeros.webp" alt="logotipo oficial do grupo artístico Companhia de Eros" role="img">
                        </figure>
                      ...
                      <section class="col-lg-4 jamais_vistos" role="region" aria-labelledby="section-heading">
                        <h3 id="section-heading">Banda Jamais Vistos</h3>
                        <figure class="text-center">
                            <img src="../imgs/cultura/bandajamaisvistos.webp" alt="logotipo da Banda Jamais Vistos, com um fundo preto e as letras brancas" role="img">
                        </figure>
