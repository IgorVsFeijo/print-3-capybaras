...
<body>
    ...
    <div class="container">
      <main class="row privacidade" role="main" aria-labelledby="main-heading">
        <h1 id="main-heading">Privacidade</h1>
        <article role="article" aria-labelledby="article-heading">
          <h2 id="article-heading">Termos de uso</h2>
          <p>
        ...
        <article class="privacidade_politica" role="article" aria-labelledby="article-heading">
          <h2 class="text-center" id="article-heading">Política de Privacidade</h2>
          <div class="row">
            <section class="col-lg-6" role="region" aria-labelledby="section-heading">
              <h3 id="section-heading">Coleta de dados</h3>
              <ol>
                <li>
            ...
            <section class="col-lg-6" role="region" aria-labelledby="section-heading">
              <h3 id="section-heading">Uso de dados</h3>
                <ol>
                  <li>
            ...
            <section class="col-lg-6" role="region" aria-labelledby="section-heading">
              <h3 id="section-heading">Armazenamento de dados</h3>
              <p>
            ...
            <section class="col-lg-6" role="region" aria-labelledby="section-heading">
              <h3 id="section-heading">Política de Cookies</h3>
              <ol>
                <li>
                Uso de Cookies:
                  <ol>
            ...
            <section role="region" aria-labelledby="section-heading">
              <h3 id="section-heading">Disposições gerais</h3>
              <p>
