...
<body>
    ...
    <div class="container">
      <main class="row quemsomos" role="main" aria-labelledby="main-heading">
        <h1 class="col-12 text-center" id="main-heading">Sobre a equipe</h1>
        <p class="col-lg-6">
        ...
        <article role="article" aria-labelledby="article-heading">
          <div class="row align-items-center sombra">
            ...
            <div class="col-lg-8 col-md-8 quemsomos_conteudo align-items-center">
              <h2 id="article-heading">Emanuele Cristina da Silva</h2>
              ...
              <p><b>Área:</b> <a href="cidadao/index.php" role="link" aria-label="link-para-ver-a-area-cidadao">Cidadão</a></p>
            </div>
          </div>
        </article>
        ...
        <article role="article" aria-labelledby="article-heading">
          <div class="row align-items-center sombra">
            ...
            <div class="col-lg-8 col-md-8 quemsomos_conteudo align-items-center">
              <h2 id="article-heading">Henrique Silva Ribeiro</h2>
              ...
              <p><b>Área:</b> <a href="cultura/index.php" role="link" aria-label="link-para-ver-a-area-cultura">Cultura</a></p>
            </div>
          </div>
        ...
        <article role="article" aria-labelledby="article-heading">
          <div class="row align-items-center sombra">
            ...
            <div class="col-lg-8 col-md-8 quemsomos_conteudo align-items-center">
              <h2 id="article-heading">Igor Vinicius Silveira Feijó</h2>
              ...
              <p><b>Área:</b> <a href="cidade/index.php" role="link" aria-label="link-para-ver-a-area-cidade">Cidade</a></p>
            </div>
          </div>
        </article>
        ...
        <article role="article" aria-labelledby="article-heading">
              <div class="row align-items-center sombra">
                ...
                <div class="col-lg-8 col-md-8 quemsomos_conteudo align-items-center">
                  <h2 id="article-heading">João Paulo de Sousa</h2>
                  ...
                  <p><b>Área:</b> <a href="governo/index.php" role="link" aria-label="link-para-ver-a-area-governo">Governo</a></p>
                </div>
              </div>
        </article>
        ...
        <article role="article" aria-labelledby="article-heading">
          <div class="row align-items-center sombra">
            ...
            <div class="col-lg-8 col-md-8 quemsomos_conteudo align-items-center">
              <h2 id="article-heading">Pietro Ricardo Black Fracalanza Muzy</h2>
              ...
              <p><b>Área:</b> <a href="turismo/index.php" role="link" aria-label="link-para-ver-a-area-turismo">Turismo</a></p>
            </div>
          </div>
        </article>
        <?php 
