...
<body>
    ...
    <div class="container">
        <main class="row cidadao" role="main">
            ...
            <article class="row sombra cidadao_servicos cidadao_assistencia" role="article">
                ...
                <section class="col-lg-4 col-md-12 col-md-12 text-center" role="region">
                    <h2>Programas</h2>
            ...
            <article class="col-12" role="article">
                <div class="row justify-content-between">
                    <section class="col-lg-4 col-md-12 col-sm-12 sombra cidadao_servicos cidadao_servicos_escolar" role="region">
                        ...
                        <div class="row text-center">
                            <table class="table text-center cidadao_calendario sombra" role="table">
                    ...
                    <section class="col-lg-7 col-md-12 col-sm-12 sombra cidadao_servicos" role="region">
            ...
            <div class=" row justify-content-between">
                ...
                <article class="col-lg-5 col-md-12 col-sm-12 sombra cidadao_servicos" role="complementary">
                    <h3 class="text-center">Postagens recentes</h3>
                    <section class="cidadao_postagem" role="region">
