...
<body>
    ...
    <div class="container text-center">
        <div class="row">
            <figure>
                <img src="../imgs/turismo/topo_desktop.webp" alt="Imagem panoramica da brasital com o logo da prefeitura de são roque ao lado direita">
            </figure>
        </div>
        <main>
        <article>
            ...
            <div class="row">
                <figure class="col-lg-6 col-md-6 col-sm-12 ">
                    <img src="../imgs/turismo/evento_castra.webp" alt="Imagem com fundo amarelo e roxo com a logo da castra móvel no canto superior esquerdo, no lado esquerdo um cachorro fofo e no meio uma escrita 17 de setembro no recanto da cascata, faça sua inscrição">
                </figure>
            ...
            <div class="row text-start">
                <section class="col-lg-3 col-md-3 col-sm-5 tur_i_shadow">
                    ...
                    <figure class="text-center">
                        <img src="../imgs/turismo/sitio_de_lazer.webp" alt="Fundo com montanhas e ceu azul com um borrado, em destaque a escrita SITIO DE LAZER em em azul escuro e borda branca">
                    </figure>
                ...
                <section class="col-lg-3 col-md-3 col-sm-5 tur_i_shadow">
                    ...
                    <figure class="text-center">
                        <img src="../imgs/turismo/cordialle.webp" alt="fundo branco com detalhes em amarelo e centralizado a escrita Cordialle Hotel nas cores verde">
                    </figure>
                ...
                <section class="col-lg-3 col-md-3 col-sm-5 tur_i_shadow">
                    ...
                    <figure class="text-center">
                        <img src="../imgs/turismo/putini.webp" alt="Logotipo com fundo preto e um circulo laranja, ao meio um simbolo cheio de circulos fazendo o formato de vento, no topo do circulo esta escrito Pousada chácara putini">
                    </figure>
        ...
        <aside class="tur_back text-center">
            ...
            <div class="row">
                <figure class="col-lg-5 col-md-10 col-sm-5 text-center tur_galeria_index">
                    <img class="tur_i_shadow img-fluid img-thumbnail rounded" src="../imgs/turismo/brasital_galeria.webp" alt="Paisagem de cima do ponto turistico Brasital, ao meio algumas construções como casas, torres e em toda volta muita floresta.">
                </figure>
                <figure class="col-lg-5 col-md-10 col-sm-5 text-start tur_galeria_index">
                    <img class="tur_i_shadow img-fluid img-thumbnail rounded" src="../imgs/turismo/ferro_galeria.webp" alt="Imagem de um trem passando ao lado de uma casa, trem de uma cor cinza com tons de marrom">
                </figure>
            </div>
        </aside>
            ...
            <div class="row text-start">
                <section class="col-lg-5 col-md-5 col-sm-12 tur_i_shadow">
                  <h3 class="hide">h3 - Section</h3>
                    ...
                    <figure class="text-center">
                        <img class="img-fluid" src="../imgs/turismo/praça_republica.webp" alt="Imagem com foco no chafariz que fica no centro da praça, ao fundo vemos bastante arvores e vegetação">
                    </figure>
                ...
                <section class="col-lg-5 col-md-5 col-sm-12 tur_i_shadow">
                  <h3 class="hide">h3 - Section</h3>
                    ...
                    <figure class="text-center">
                        <img class="img-fluid" src="../imgs/turismo/outlet_catarina.webp" alt="Imagem do outlet catarina de cima, mostrando ao fundo toda a extensão das estruturas do outlet, mais para frente o enorme estacionamento do mesmo, com diversos carros">
                    </figure>
        ...
        <section>
            ...
            <div class="row text-start">
                <section class="col-lg-3 col-md-3 col-sm-5 tur_i_shadow">
                    ...
                    <figure class="text-center">
                        <img class="img-fluid" src="../imgs/turismo/alma_galiza.webp" alt="Fundo branco, com duas palavras escritas com tipografias estilizadas, e abaixo das duas palavras tem tres simbolos portugueses, um vermelho, outro amarelo e o terceiro verde. esta escrito Alma Galiza">
                    </figure>
                ...
                <section class="col-lg-3 col-md-3 col-sm-5 tur_i_shadow">
                    <h4>Come Together</h4>
                    <figure class="text-center">
                        <img class="img-fluid" src="../imgs/turismo/cct.webp" alt="Uma logotipo em formato de paleta com as escritas dentro Come Together em letra de mão e branco">
                    </figure>
                ...
                <section class="col-lg-3 col-md-3 col-sm-5 tur_i_shadow">
                    <h4>Tia Lina</h4>
                    <figure class="text-center">
                        <img class="img-fluid" src="../imgs/turismo/tia_lina.webp" alt="Logotipo com borda verde e vermelha, na parte de cima escrito cantina, ao meio uma faixa verde escrito dentro de branco Tia Lina, abaixo dessa faixa, tem massas de macarrão com tomate, em baixo dessas massas, esta escrito Comida Italiana em vermelho">
                    </figure>
