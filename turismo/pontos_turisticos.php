        ...
        <article role="article">
            ...
            if ($resultado->num_rows > 0) {
                while ($linha = $resultado->fetch_assoc()) {
                    echo "<a class='btn btn-secondary col-lg-4 col-md-4 col-sm-6 tur_btn-vermais' href='ponto_turistico.php?codigopontoturistico=".$linha['CodigoPontoTuristico']."' role='button'>"
